...
FY21_ITEM_PATH = '/Gray Sky/Avis Reports/FY21 Avis Report'
...
DR_NUM = '98'       # without any leading zero
DR_YEAR = '21'      # two digit year; will add optional leading '20'; yes this breaks next century...
